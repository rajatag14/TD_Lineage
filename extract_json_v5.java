                ...
                if (result != null) {
                    ...
                    if (concatenatedQueries != null && !concatenatedQueries.isEmpty()) {
                        ...
                        if (finalResult != null) {
                            ...
                            lines.add(filename + "," + durationInSec + "," + jsonFilename + ",PARTIAL");
                        } else {
                            System.out.println(filename + " failed final re-parsing");
                            lines.add(filename + "," + durationInSec + ",FAILED,REPARSE_FAILURE");
                        }
                    } else {
                        System.out.println(filename + " had no successful queries");
                        lines.add(filename + "," + durationInSec + ",FAILED,NO_SUCCESSFUL_QUERIES");
                    }
                }
            }
        }
